...
{
	$title = "<h1> Welcome to the LIFESTYLE.CA!</h1> please create a fitness and nutrition account to use this app.";
...
<td>  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
<p style="display:inline" id="MyTitle"> These are the informations for  </p>  <p style="display:inline" id="gram"> </p> <p style="display:inline" id="Title2">   </p>  <p style="display:inline" id="MyTitle">grams   </p> 
<ul id="info">
