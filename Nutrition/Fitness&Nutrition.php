...
.mbloginbtn2:link, .mbloginbtn2:visited {
  ...
  .mbloginbtn2:hover, .mbloginbtn2:active {
	...
	<body>
        ...
        <div class="mbtablediv">
            <table>
                <tr>
                    <td>
                        <img src="../finances/finances_img/potentiallogo.png" alt="logo" style="width:50px;height:50px; float: left;">
                    </td>
                    <td>
		...
		<section class="SecondMainDivTag">
			...
			<section class="MainDivTag">
				<div class="picturediv", id="pic3">
					...
					<p style="text-align:center;">  <button style="padding: 10px 25px;"  class="mbloginbtn2" onclick = "window.location.href = 'FooDDataBase.php' ">Click here to Open your nutrition tool</button> </p>
