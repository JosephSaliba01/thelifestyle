...
<head>
   ...
   <meta charset="UTF-8" />
   <title></title>
   <link rel="stylesheet" type = "text/css" href="Fitness&Nutrition_css/Lifestyle.css?v=<?php echo time(); ?>"/>
			...
			<section class="SecondMainDivTag">
				...
				<div class="background-section2">
					<table  class="Table2">
						<tr>
							<td>
								<ul>
								<h2 style="font-size:50px;"> Yoga</h2>
								<p> Yoga, a perfect indoor activity which you can <br>
								do anywhere, even from the comfort of your own <br>
								home. This activity requires little to no equipment and <br>
								relieves stress throughout the process.
								</p>
							...
							<td >
								<div class="slidershow">
									<div class="slides">
										...
										<div class="slide s1">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/sTANio_2E0Q" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/b1H3xO3x_Js" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/v7AYKMP6rOE" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/oMOgnSMcfM0" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/sJfkWNW183U" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
				...
				<table  class="Table3">
					<tr>
							<td >
								<div class="slidershow2">
									<div class="slides2">
										...
										<div class="slide s1">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/Znt0UuZW2nU" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/9YERydwHUeM" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/ZiGE3-L4vyg" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/nU-cibITvaY" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/TfWOMNdiqSs" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
							...
							<td>
								<ul>
								<h2 style="font-size:50px;"> Biking </h2>
								<p> Whether you own a bike or would like to know which <br>
									type of bike to purchase for indoors or outdoors, we <br>
									got you covered. Throughout the videos, we also show a <br>
									30 minute workout session along with some advantages on <br>
									exercising using an indoor bike and outdoor bike.
								</p>
				...
				<div class="background-section2">
					<table  class="Table4">
						...
						<tr>
							<td>
								<ul>
								<h2 style="font-size:50px;"> Outdoor & <br>Indoor Activities </h2>
								<p> This section is for your general information on different <br>
									types of activities that you can do indoors and outdoors <br>
									for your lifestyle exercises. From hockey to swimming, here <br>
									are our top 5 recommended videos.
								</p>
								<br><br><br><br>
								</ul>
							</td>
							<td >
								<div class="slidershow3">
									<div class="slides3">
										...
										<div class="slide s1">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/ubJzSM5Iy2w" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide3">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/U3N_qXaqrtI" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide3">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/tylbjEuchxU" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide3">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/2lFq7T6pmu8" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
										<div class="slide3">
											<iframe width="700" height="445" src="https://www.youtube.com/embed/ZSpERPtj8Yk" frameborder="0"
												allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
												allowfullscreen>
											</iframe>
										</div>
